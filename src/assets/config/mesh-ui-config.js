...
window.MeshUiConfig = {
    ...
    uiLanguages: ['en', 'de', 'cs', 'sk', 'hu', 'pl', 'it', 'hr', 'bg', 'uk', 'ru', 'ro'],
    /** The ISO-639-1 codes of the available languages for Mesh */
    contentLanguages: ['en', 'de', 'cs', 'sk', 'hu', 'pl', 'it', 'hr', 'bg', 'uk', 'ru', 'ro', 'sr', 'bs', 'mr'],
    ...
    previewUrls: [
        {
            ...
            urlResolver: function(node) {
                ...
                switch (node.schema.name) {
                    ...
                    default:
                        throw new Error(
                            'No existing app route preview mapping configured for node of schema: ' + node.schema.name
                        );
                }
